...
<?php
//Check whether id is set or not - kiem tra xem id da duoc dat hay chua
if (isset($_GET['id'])) {
    //Get all the details
    $id = $_GET['id'];
    ...
    //Get the value based on query executed - nhan gia tri dua tren truy van duoc thuc thi
                ...
                <tr>
                    ...
                    <td>
                        <select name="category">
                            ...
                            <?php
                            //Query to Get Active Categories - viet truy van de co danh muc hoat dong
                            $sql = "SELECT * FROM tbl_category WHERE active='Yes'";
                            //Execute the Query - thuc thi truy van
                            $res = mysqli_query($conn, $sql);
                            //Count Rows
                            $count = mysqli_num_rows($res);

                            //Check whether category available or not - kiem tra xem danh muc co san hay khong
                            if ($count > 0) {
                                //Category Available 
